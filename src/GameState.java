...
public class GameState extends ArrayList<Player> implements Serializable {
    ...
    public void getPlayers(boolean allBots){
        if(!allBots) {
            this.add(new Player("Human", true));
            this.add(new AI_Player("Robot", false, true, 1500));
        }
        else {
            this.add(new AI_Player("T.E.N.C.H. 889B", true, true, 1500));
            this.add(new AI_Player("Vulcan 2", false, true, 1500));
