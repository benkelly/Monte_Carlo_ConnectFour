...
public class AI_Player extends Player {
    ...
    int TRAINING_GAMES = 80;



    public AI_Player(String name, boolean ifYellow, boolean isBot, int trainingGames) {
        super(name, ifYellow);
    ...
    public int suggestMonteCarlo() {
        ...
        for (int move = 0; move < Board.getInstance().size(); move++) {
            ...
            {
                System.out.println("Column: "+Board.getInstance().getCharForNumber(move+1)+" is Full!");
            ...
            System.out.println("Column: " + Board.getInstance().getCharForNumber(move+1) + " ratio: " + ratio);
        ...
        System.out.println("\t\t\t\t\t\t\t\tBEST COLUMN: "+Board.getInstance().getCharForNumber(bestColumn+1));
        return bestColumn;
    }
    ...
    private boolean simulateGame(Board b) {
        ...
        if (this.isRed) {
            isRorY = false;
            yBot = new AI_Player("Vulcan 3",true, true, 80);
            rBot = this;
        }
        if (this.isYellow) {
            isRorY = true;
            rBot = new AI_Player("Vulcan 3",false, true, 80);
            yBot = this;
        }
        while (!gameLoop) {
    ...
    public static void main(String[] args) {
        ...
        AI_Player player = new AI_Player("Melcin",true,true, 1000);
